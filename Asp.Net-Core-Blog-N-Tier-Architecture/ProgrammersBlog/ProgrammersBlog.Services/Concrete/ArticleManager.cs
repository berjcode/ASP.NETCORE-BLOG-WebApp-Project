...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager:IArticleService
    {
        ...
        {
            var articleCount = await _unitOfWork.Articles.CountAsync(); // yani hepsini sayacak.
        ...
        {
            var articleCount = await _unitOfWork.Articles.CountAsync(a => !a.IsDeleted); //isdeleted değeri false olanları getir.
