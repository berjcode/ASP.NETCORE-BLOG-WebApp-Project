$(document).ready(function () {
    ...
    /* DataTables end here  UndoDelete */
    $(document).on('click',
        '.btn-undo',
        function (event) {
            ...
            Swal.fire({
                ...
                text: `${categoryName} başlıklı kategori arşivden geri getirilecektir!`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Evet, arşivden getirmek istiyorum.',
                cancelButtonText: 'Hayır, getirmek  istemiyorum.'
            }).then((result) => {
    ...
    /* DataTables end here  HardDelete */
    $(document).on('click',
        '.btn-delete',
        function (event) {
            event.preventDefault();
            ...
            Swal.fire({
                ...
                text: `${categoryName} başlıklı kategori kalıcı olarak silinecektir.`,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (hardDeleteResultResultStatus === 0) {
                                Swal.fire(
                                    'Arşivden geri getirildi!',
