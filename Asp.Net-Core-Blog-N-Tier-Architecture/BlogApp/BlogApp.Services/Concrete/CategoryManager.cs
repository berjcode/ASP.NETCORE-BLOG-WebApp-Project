...
namespace BlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> Add(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            // yeni bir task ile zincirleme yaptık. bitir bitirmez bu işlemi yapar. performans katar. 
         ...
         * await _unitOfWork.Categories.AddAsync(new Category
            {
                ...
                IsDeleted = false
            }).ContinueWith(t => _unitOfWork.SaveAsync()); // yeni bir task ile zincirleme yaptık. bitir bitirmez bu işlemi yapar. performans katar. 
