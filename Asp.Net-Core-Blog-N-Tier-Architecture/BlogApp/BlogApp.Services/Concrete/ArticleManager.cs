...
namespace BlogApp.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Add(ArticleAddDto articleAddDto, string createdByName)
        {
            ...
            return new Result(ResultStatus.Success,$"{articleAddDto.Title} başlikli makale başarıyla eklenmiştir.");
        }
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title} başlikli makale başarıyla Silinmiştir.");
            }
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                return new Result(ResultStatus.Success, $"{article.Title} başlikli makale başarıyla veri tabanından Silinmiştir.");
            }
            return new Result(ResultStatus.Error, "Böyle bir makale bulunamadı");
        }
